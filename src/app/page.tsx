...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-body antialiased flex flex-col items-center">
      ...
      {(isLoading || !detection) ? (
        <div className="flex-1 flex flex-col items-center justify-center bg-slate-50 transition-opacity duration-500">
          ...
          <div className="bg-white rounded-[2rem] shadow-xl shadow-slate-200/40 border border-white p-6 md:p-8 text-center space-y-6 transition-all duration-700">
            ...
            <div className="space-y-4">
              <Button 
                ...
                size="lg" 
                className="w-full h-12 rounded-xl text-sm font-bold shadow-lg shadow-primary/20 transition-all hover:scale-[1.01] active:scale-[0.99] bg-primary hover:bg-primary/90"
              >
                Verify & Continue
